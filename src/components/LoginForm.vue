    ...
    <div class="modal" id="addModal">
      <div class="modal-header">
        <slot name="header">
          ...
          <button type=button class="modal-close__button" @click="$emit('loginFormClose')">
            X
          </button>
        </slot>
      </div>
      ...
      <div class="modal-footer">
        <slot name="footer">
          <button v-if="toggleTaskStatus" type="submit" class="modal-confirm__button" @click="$emit('loginFormEnter')">
            Login
          </button>
        </slot>
      </div>
